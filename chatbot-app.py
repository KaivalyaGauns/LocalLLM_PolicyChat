...
from emptyfolder import empty_folder
...
def data_ingestion(file_name):
    ...
    db.persist()
    print("_---------------------------____________--------__________-----_____________________")
    db=None 
...
def main():
    st.markdown("<h1 style='text-align: center; color: blue;'>Chat with your Policy Document </h1>", unsafe_allow_html=True)
